...
-- Vim Tmux Navigator
vim.keymap.set("n", "<C-h>", "<CMD>TmuxNavigateLeft<CR>", { silent = true, noremap = true, desc = "Window left" })
vim.keymap.set("n", "<C-j>", "<CMD>TmuxNavigateDown<CR>", { silent = true, noremap = true, desc = "Window down" })
vim.keymap.set("n", "<C-k>", "<CMD>TmuxNavigateUp<CR>", { silent = true, noremap = true, desc = "Window up" })
vim.keymap.set("n", "<C-l>", "<CMD>TmuxNavigateRight<CR>", { silent = true, noremap = true, desc = "Window right" })
